...
case $OSTYPE in
	darwin*)
		...
		export PATH=/opt/local/Library/Frameworks/Python.framework/Versions/2.6/Resources/Python.app/Contents/MacOS:/opt/local/bin:/opt/local/sbin:$PATH:/Library/Frameworks/UIM.framework/Version/1.6.0/bin
