...
hi Normal guifg=slategray3 guibg=#000029 ctermfg=248 ctermbg=none
...
hi DiffAdd guibg=slategray4 ctermbg=189
hi DiffChange guibg=steelblue3 guifg=bg gui=NONE ctermbg=blue
hi DiffDelete guibg=slategray4 guifg=slategray3 ctermbg=189
hi DiffText guibg=steelblue4 gui=bold ctermfg=gray ctermbg=red
hi ErrorMsg guibg=red3 ctermfg=white
"hi VertSplit  
...
"hi Identifier 
hi Statement guifg=khaki3 gui=bold ctermfg=15
